...
//    }
    ...
    double rungameMode(Graphics graphics, Mix_Chunk* gPick, Mix_Chunk* gClick, SDL_Texture* selectMode, SDL_Texture* Back ) {
        ...
        while (true) {
            ...
            // graphics.Draw_Font("Fruits Basket", 150, 120, 80, {21, 52, 72}, "Font//iCiel Crocante.otf");
            SDL_GetMouseState(&x, &y);
    ...
    double clickGameover(Graphics graphics, Mix_Chunk *gClick, SDL_Texture* Gameover){
        int downx = 0;
        int downy = 0;
        while (true){
